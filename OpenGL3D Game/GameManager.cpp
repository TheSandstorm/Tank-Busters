...
CGameManager::CGameManager()
{
	...
	EndGameTitle = std::make_shared<CTextLabel>("You Died!", Utility::NormalFontString.data(), glm::vec2(90.0f, 100.0f));
	...
	ScoreText = std::make_shared<CTextLabel>("SCORE: 0", Utility::NormalFontString.data(), glm::vec2(-380.0f, -100.0f));
	LivesText = std::make_shared<CTextLabel>("LIVES: 3", Utility::NormalFontString.data(), glm::vec2(300.0f, 300.0f));
...
#pragma region EndMenu
	...
	EndMenu = std::make_shared<CMenu>(EndOpt, glm::vec2(90.0f, 280.0f));
#pragma endregion
